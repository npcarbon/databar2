...
?>
	...
	<body>
		...
		<session>
			<div class="product" style="background: url(images/services/KV_pc.jpg); min-height: 500px;  background-size: cover; background-repeat: no-repeat; background-position: center;">
			...
			<session>
				<div class="container-fluid" style="padding: 0 10% 0 10%;">
					<div class="row" style="height: 700px;">
						<strong><h1 style="padding: 3% 0 3%; font-size: 50px; font-weight: 700;">What product do you have?</h1></strong>
						<div class="ser-list">
							<div class="col-md-3">
								<div class="ser-box" style="border-right: 1px solid #999;">
								<img src="images/services/smartphone.png" width="100px" style="padding:4% 0 0 0;" alt="">
									<h4 style="padding: 15% 0 0 0;">Samsung Consumer Graded Tablets & Smartphones, Wearable </h4>
									<p>ศูนย์บริการซ่อมสมาร์ทโฟน แท็บเล็ต warranty และ out warranty ที่ศูนย์บริการซัมซุงหรือติดต่อ</p>
								</div>
							</div>
							<div class="col-md-3">
								<div class="ser-box" style="border-right: 1px solid #999;">
									<img src="images/services/rugged.png" width="100px" style="padding:4% 0 0 0;" alt="">
									<h4 style="padding: 15% 0 0 0;">Samsung Rugged Tablets & Smartphones </h4>
									<p>ศูนย์บริการซ่อมสมาร์ทโฟน แท็บเล็ต warranty และ out warranty ที่ศูนย์บริการซัมซุงหรือติดต่อ</p>
								</div>
							</div>
							<div class="col-md-3">
								<div class="ser-box" style="border-right: 1px solid #999;">
									<img src="images/services/sknox.png" width="100px" style="padding:4% 0 0 0;" alt="">
									<h4 style="padding: 15% 0 0 0;">Samsung Knox </h4>
									<p>ศูนย์บริการซ่อมสมาร์ทโฟน แท็บเล็ต warranty และ out warranty ที่ศูนย์บริการซัมซุงหรือติดต่อ</p>
								</div>
							</div>
							...
							<div class="col-md-3">
								<div class="ser-box">
								<img src="images/services/orther.png" width="200px" alt="">
									<h4 style="padding: 11% 0 0 0;">Non Samsung Products </h4>
									<p>ศูนย์บริการซ่อมสมาร์ทโฟน แท็บเล็ต warranty และ out warranty ที่ศูนย์บริการซัมซุงหรือติดต่อ</p>
								</div>
							</div>
						</div>
		...
		<div id="product" style="background: url(images/services/Banner_Service2.jpg); background-size: cover; background-repeat: no-repeat; background-attachment: fixed; background-position: center; ">
			...
			<div class="container-fluid" style="padding: 1% 0 5% 0;">
             ...
             <p style="color: #fff;"> On-site service supports
              Extended warranty for 1-2 years, 1-3 years
              Authorized repair services
              Hotline / Help Desk</p><br><br> -->
