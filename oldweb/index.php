               ...
               <section class="awSlider" style="margin: auto auto;">
                 <div  class="carousel slide" data-ride="carousel">
                   ...
                   <div class="carousel-inner" role="listbox">
                     ...
                     <div class="item">
                       <img src="images/slides/GTA_6.jpg">
    ...
    <div class="container-fluid ">
          ...
          <div class="row">
                <div class="text-center" style="padding: 0 10% 0 10%"> 
                  <div class="wow fadeInUp product-form" data-wow-delay="0.3s">
                      <h2>Product</h2><br>
                      <p>DATABAR is business-to-business (B2B) distributor of Samsung enterprise mobility, Samsung KNOX (EMM), 42Gears mobility solutions – SaaS/On-cloud and On-premise, <br>barcode and complementary mobility solutions on Samsung Android, Android, iOS, Windows OS platforms.</p>
