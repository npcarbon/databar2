...
<div class="navbar navbar-default navbar-static-top" role="navigation">
  <div class="container">
    ...
    #gsc-i-id1{background: white !important; font-size: 12px!important;line-height: 24px!important;}
...
<div class="row">
       ...
       <style type="text/css">
           @media (max-width: 1007px)and (min-width:440px)  { 
            .feature{margin-bottom:110px;}
            }
        ...
        <div class="col-md-4 feature s">
        	...
        	<div>
         		 <h2 style="font-size:16px;line-height: 1.25em;font-weight:normal;">Reseller Services</h2>
                 </a>
              <p>
                DATABAR is authorized repair and service support for Samsung enterprise mobility, Samsung
                 Galaxy Tab Active, Samsung KNOX, barcode and complementary solutions.
.</p>
...
<div class="col-lg-12 menu">
                ...
                <div class="form-group has-success">
                    <div  class="tbl1">
                     ...
                     <h4>&nbsp;</h4>
                     <h4><a href="http://www.samsung.com"><b>SAMSUNG</b></a></h4>
                     <h5><b>PRODUCT</b></h5>
...
<footer id="fw-footer">
  <div class="container">
    <!--<p class="text-muted" style="color:#000;"> -->
        ...
        <li><a href="channelpartner.php">Channel Partner</a></li>
