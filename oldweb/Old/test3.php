...
<div class="navbar navbar-default navbar-static-top" role="navigation" style="background-color:#3c6aa1;background:-webkit-linear-gradient(top,#4d80af 0,#2b5593 100%);">
  <div class="container">
    <div class="navbar-header">
        ...
        <a class="text-muted pull-left" href="index.php"><img src="images/logo-120x130.png" class="logo-wd" style="height:60px;" /></a>
   </div>
    <div class="navbar-collapse collapse">
                                     <div class="input-group navbar-right" style="margin-top:7px;">
     <style type="text/css">
