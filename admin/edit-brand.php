...
?>
	<div class="container">
		<form class="form-control" method="post" action="data/edit-brand.php" style="padding-top: 50px; background-color: ##F5F5F5;" enctype="multipart/form-data">
		<h1>Edit Type</h1>

				<h5>Type's Picture </h5><br>
				<input type="text" name="brand_id" value="<?= $rs['Brand_ID']?>" hidden>
				<h5 style="padding-top: 20px;">Brand Name </h5>
				<input type="text" name="brand_name" class="form-control" value="<?= $rs['Brand_Name']?>">
				<h5 style="padding-top: 20px;">Group Name </h5>
