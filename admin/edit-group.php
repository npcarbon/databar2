...
?>
	<div class="container">
		<form class="form-control" method="post" action="data/edit-group.php" style="padding-top: 50px; background-color: ##F5F5F5;" enctype="multipart/form-data">
		<h1>Edit Type</h1>

				<h5>Type's Picture </h5><br>
				<input type="text" name="group_id" value="<?= $rs['Group_ID']?>" hidden>
				<h5 style="padding-top: 20px;">Group Name </h5>
				<input type="text" name="group_name" class="form-control" value="<?= $rs['Group_Name']?>">
